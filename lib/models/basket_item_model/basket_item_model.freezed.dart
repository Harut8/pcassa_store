...
mixin _$BasketItemModel {
  ...
  String get name => throw _privateConstructorUsedError; //int? dep,
  int? get deletepersonid => throw _privateConstructorUsedError;
  int get quantity => throw _privateConstructorUsedError;
  double get realprice => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      name: null == name
          ...
          : name // ignore: cast_nullable_to_non_nullable
              as String,
      deletepersonid: freezed == deletepersonid
          ? _value.deletepersonid
          : deletepersonid // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$_BasketItemModel extends _BasketItemModel {
  _$_BasketItemModel(
      {this.id = 0,
      required this.code,
      this.name = '',
...
//int? dep,
  ...
  @override
  String toString() {
    return 'BasketItemModel(id: $id, code: $code, name: $name, deletepersonid: $deletepersonid, quantity: $quantity, realprice: $realprice, saleprice: $saleprice, recorddate: $recorddate, flag: $flag, edizm: $edizm, kname: $kname, adg: $adg)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.deletepersonid, deletepersonid) ||
                other.deletepersonid == deletepersonid) &&
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, code, name, deletepersonid,
      quantity, realprice, saleprice, recorddate, flag, edizm, kname, adg);
...
abstract class _BasketItemModel extends BasketItemModel {
  factory _BasketItemModel(
      ...
      final String? edizm,
      final String? kname,
      final String? adg}) = _$_BasketItemModel;
