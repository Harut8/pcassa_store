...
abstract class $LanguageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? language, String? tip});
}
...
class _$_LanguageModel implements _LanguageModel {
  _$_LanguageModel(
      {required this.id, required this.language, required this.tip});
  ...
  @override
  String toString() {
    return 'LanguageModel(id: $id, language: $language, tip: $tip)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, language, tip);
...
abstract class _LanguageModel implements LanguageModel {
  factory _LanguageModel(
      ...
      required final String? tip}) = _$_LanguageModel;
